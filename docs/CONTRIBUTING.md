...
# 启动数据刷新（后台运行）
bash scripts/run_loop.sh &  # 或 Windows: .\scripts\run_loop.ps1

# 启动看板服务器
python3 dashboard/server.py  # 或 Windows: python dashboard/server.py
...
- GitHub Issues: [提交问题](https://github.com/838997125/Tang-Political-System/issues)
- GitHub Discussions: [社区讨论](https://github.com/838997125/Tang-Political-System/discussions)
...
*本文档由根目录 `CONTRIBUTING.md` 迁移至 `docs/CONTRIBUTING.md`*
